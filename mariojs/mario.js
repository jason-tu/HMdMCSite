...
*/
		...
		init : function(){
			...
			// TODO: Grab data from textbox and use as json.

			var mapData = document.getElementById("data").value;

			var rawJSON = "[";

			var lines = mapData.split("\n");
			for (var c = 0; c < lines.length; c++) {
				var currLine = lines[c];
				for (var r = 0; r < currLine.length; r++) {
					var currChar = lines[c].charAt(r);
					...
					if (currChar == "-") {
						...
						type = "\"questionmark\"";
					        ...
					        var toReturn = "{\"sx\":" + sx + ", \"sy\": " + sy + ", \"sw\": 16, \"sh\": 16, \"dx\": " + dx + ", \"dy\": " + dy
                + ", \"dw\":16, \"dh\": 16, \"type\": " + type + " }";
                	rawJSON += toReturn + ", ";
				}
			}
